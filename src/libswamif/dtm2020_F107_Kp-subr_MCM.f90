...
subroutine dtm3(day,f,fbar,akp,alti,hl,alat,xlon,tz,tinf,ro,d,wmm)
  ...
  ! for use in Whole Atmosphere Model MCM
  !  
  !*par ** INPUT **
  ...
  real :: atten ! for transition with UM
  ! 
  !.. Local Arrays .. 
  ...
  real, dimension(nlatm) :: az2_mcm  ! for transition with UM
  !
  !.. Common Blocks .. 
...
!
    ...
    dbase(3)=o(1)*dox(1)
!
  if(alti.gt.150.0) then
    call gldtm(f,fbar,akp,day,az2,daz2,gdelaz2,1.,xlon)
    daz2(1)=exp(gdelaz2)
    dbase(4)=az2(1)*daz2(1)
  else                           
    atten = (alti-120.)**3/27000.
    az2_mcm(21)=atten*az2(21)
    az2_mcm(22)=atten*az2(22)
    az2_mcm(23)=atten*az2(23)
    az2_mcm(26)=atten*az2(26)   
    az2_mcm(27)=atten*az2(27)
    az2_mcm(28)=atten*az2(28)       
    az2_mcm(31)=atten*az2(31)
    az2_mcm(33)=atten*az2(33)   
    az2_mcm(35)=atten*az2(35)
    az2_mcm(36)=atten*az2(36)  
    az2_mcm(90)=atten*az2(90)
    az2_mcm(91)=atten*az2(91)    
    call gldtm(f,fbar,akp,day,az2_mcm,daz2,gdelaz2,1.,xlon)
    daz2(1)=exp(gdelaz2)
    dbase(4)=az2(1)*daz2(1)
  endif
!
...
subroutine gldtm(f,fbar,akp,day,a,da,gdel,ff0,xlon)
  !***********************************************************************
  ! SB 21/10/2020
  ! Corrections and some modifications
...
subroutine lecdtm(iu10)
  ...
  !     iu10 = tape number of DTM coefficient file
!************************************************************************
  !.. Parameters .. 
  integer, parameter :: nlatm = 96
  ! 
  !.. Formal Arguments .. 
  integer, intent(in) :: iu10
  !
